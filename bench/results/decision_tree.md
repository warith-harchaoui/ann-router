...
Generated by `bench.calibrate` from `bench/results/measurements.yaml` (491 measured cells). Diamond labels carry this run's measured thresholds, one value per dim.
